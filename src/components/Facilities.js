...
function Facilities(){
    const abtICT = "We have well equiped ICT laboratories with enough computers for each student";
    const abtLibrary = "A standard library with a complete set of resources for all our student needs"
    const abtHostel = "There is a complete, state of the arts hostel accommodation for all boarding students"
    const abtConvenience = "Top rated convenience facilities available to students, staff and all our esteemed visitors"
    const abtResearchCenter = "Research center, with modern equipments for all science research and college experiments"
    const abtStaff = "We pride in the bests, with grand experience very agile and dedicated to your child's success"
