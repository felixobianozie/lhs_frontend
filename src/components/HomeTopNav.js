    ...
    return (
        <>
            ...
            <div className="w3-cell-row w3-black w3-container">
                ...
                <Link to="/notice" className={topNav.desk[4]} onClick={() => switchTabIndicator(4)}><strong>NOTICE BOARD</strong></Link>
            ...
            <div id="home_nav" className="w3-center w3-hide w3-hide-large w3-animate-zoom">
                ...
                <Link to="/notice"><div className={topNav.mob[4]} onClick={() => {switchTabIndicator(4); dropDown()}} style={mobileStyle}><strong>NOTICE BOARD</strong></div></Link>            
