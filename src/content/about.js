...
export const howItAllStarted = (
    <>
        <p>
            The story of Lutheran High School, Obot Idim, Uyo started on December 10, 1930, when the congregation of the sixteen villages in Ibesikpo namely: Nung Udoe, Nung Ukana, Ikot Essien, Ikot Ekwere, Ikot Iko, Ikot Akpan Abia, Ikot Oduot, Ikot Oku Ubo, Ikot Obio Offong, Mbikpong Ikot Edim, Ebere Otu, Afaha Ibesikpo, Afaha Ikot Osom, Mbierebe Obio, Ito Oko and Ikot Okubo all in Ibesikpo Asutan L.G.A of Akwa Ibom State, Nigeria, left the Qua Iboe Mission in protest after many years of unsatisfactory relationship. Under the leadership of Chief Nyong Etim Udo, the people formed what was known as <q>Ibesikpo United Church</q>.
        </p>

        <p>
            Two years after, the Ibesikpo United Church, which later became <q>Evangelical Lutheran Church</q> when Rev. Dr. Jonathan Udo Ekong, whom the former sent to the United States of America to source for a mission which they (Ibesikpo United Church) could be affiliated to, saw an article written by Prof. Martin S. Sommer titled: <q>AFRICA - WE OUGHT TO BE THERE.</q>
        </p>
...
export const academicRecords = (
    <>
        <p>
            The academic records of LHS have always been impressive right from her inception so much so that INSPECTORS OF EDUCATION in the then Eastern Region, from Enugu once made the following observation:<br/>
...
export const teachingLearning = (
    <>
        ...
        <ul>
            <li><b>Project-based learning</b> - here we involve our students to work on projects that address real-world problems.</li>
            <li><b>Inquiry-based learning</b> - here we encourage students to ask questions and explore answers through research and hands-on activities.</li>
            <li><b>Collaborative learning</b> - This approach involves students working together in groups to solve problems and complete tasks.</li>
            <li><b>Technology-enhanced learning</b> - This approach makes use of technology tools to support and enhance the learning process.</li>
        </ul>
    </>
)
...
export const whyUs = (
    <>
        <ol>
            <li>Full Boarding Facilities</li>
            <li>Highly qualified and experienced staff</li>
            <li>Optimum class size and an ideal staff-students ratio</li>
            <li>Attention to develop talents beyond the classroom</li>
            <li>National and International Programs: WASSCE, SAT</li>
            ...
            <li>On-campus residency of staff</li>
            <li>High academic and moral standards leading to students' independent and excellent perfomances in all examinations</li>
            <li>Strong commitment and support of members of the Board of Governors</li>
            <li>Well Equipped Science and Computer laboratories for Junior and Senior Schools</li>
            <li>Well equipped and standard library</li>
            <li>Standard Healthcare Centre for prompt healthcare</li>
            <li>Well equipped Food and Nutrition Laboratory</li>
            <li>Overall passion for excellence</li>
        </ol>
    </>
)